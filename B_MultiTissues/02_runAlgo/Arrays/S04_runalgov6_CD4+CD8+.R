...
## Data directory
data_dir <- "/home/alice/arraysh5_CD4+CD8+"
...
cpg_names_all <- rhdf5::h5read("/home/alice/arraysh5_CD4+CD8+/all_matrix_noscale.h5", "cpg_names")

## Run
message("Run algo:")

system.time(runAndSave_fast(
    analysis = "Arrays_CD4+CD8+/",
    ...
    p1 = 0.65,
    batch_size = 10000,
    Nds = 2) ## requires only 2 datasets to compute (default: 3)
)
