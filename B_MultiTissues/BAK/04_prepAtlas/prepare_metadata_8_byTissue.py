...
# Add Analysis group
df["Analysis group"] = df["Group simplified"].astype(str)

# Determine output path
meta_out = args.output if args.output else os.path.splitext(args.meta)[0] + "_8_byTissue.csv"
