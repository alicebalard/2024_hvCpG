...
p
# 2D Venn diagram
saveRDS(p, "../../../2024_hvCpG/B_MultiTissues/dataOut/figures/arrayCutoffLowPower3ind.RDS")

## And what about 2?
# Keep 2 random columns per element
...
# List of items
x <- list("Full array" = hvCpGs_repro_maria$cpgs, 
          "Array 2ind/ds" = hvCpGs_repro_maria_2ind$cpg)

p <- ggVennDiagram(x, label_alpha = 0) +  scale_fill_gradient(low = "#F4FAFE", high = "#4981BF") 
p
# 2D Venn diagram
saveRDS(p, "../../../2024_hvCpG/B_MultiTissues/dataOut/figures/arrayCutoffLowPower2ind.RDS")
```
