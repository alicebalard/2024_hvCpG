...
if (!file.exists(file.path(here::here("B_MultiTissues/dataOut/figures/correlations/correlation_Atlas_11_vs_9_immuneEffect.pdf")))){
  makeCompPlot(
    X = readRDS(here::here("gitignore/resultsAtlasPrepared/fullres_0_8p0_0_65p1_11_noImmune_sample11gp.rds")),
    Y = readRDS(here::here("gitignore/resultsAtlasPrepared/fullres_0_8p0_0_65p1_09_immuneOnly.rds")),
    whichAlphaX = "alpha",
    whichAlphaY = "alpha",          
...
# We find 17880567 (82%) stable CpGs, 
# 994693 (5%) cell universal hvCpGs, 
# 1626368 (7%) immune cell hvCpGs 
# and 1231341 (6%) hvCpGs undetected in immune cells, 
# out of a total of 21732969 CpGs investigated

## Prediction 1: Using only the immune cells in WGBS Atlas should give a result closer to what is observed using the array

testPred1=TRUE # change if needs to rerun
...
#   }
#   
#   a <- readRDS(here::here("gitignore/resultsAtlasPrepared/fullres_0_8p0_0_65p1_atlas_general.rds"))
#   head(a)
...
#     X = resCompArray,
#     Y = readRDS(here::here("gitignore/resultsAtlasPrepared/fullres_0_8p0_0_65p1_11_noImmune_sample11gp.rds")),
#     whichAlphaX = "alpha_array_all",
#     whichAlphaY = "alpha")
#   
