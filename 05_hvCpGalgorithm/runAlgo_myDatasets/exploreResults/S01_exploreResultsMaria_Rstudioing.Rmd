...
## SD & 95% CI  hvCpGs minus controls in all datasets

I computed the row(CpG)-wise standard deviation difference between hvCpG and their matched control CpGs for each dataset & calculated the median difference and inner 95% range (2.5th to 97.5th percentile) across CpGs, both for all individuals and for just the first three individuals of each dataset.
