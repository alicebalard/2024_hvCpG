...
## Load positions with high alpha, to test for SIV

highAlphaPos_atlas0.7 <- readRDS(here("05_hvCpGalgorithm/runAlgo_myDatasets/exploreResults/fetalSIV/highAlphaPos_atlas0.7.RDS"))
...
arrayBkg <- unique(setdiff(unique(fetalData_long$chrpos_hg38), 
                           union(prevDetSIV, highAlphaPos_atlas0.7$chrpos_hg38)))
...
fetalData_subset_highVar <- fetalData_long[fetalData_long$chrpos_hg38 %in% highAlphaPos_atlas0.7$chrpos_hg38,]
