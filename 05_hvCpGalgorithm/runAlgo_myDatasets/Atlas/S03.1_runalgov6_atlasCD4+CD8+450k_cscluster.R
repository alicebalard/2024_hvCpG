...
cpg_array_hg38 <- read.table(file.path(data_dir, "selected_cpgs_min3_in2_datasets.txt"))$V1
...
# Output directory
result_dir <- sprintf("/SAN/ghlab/epigen/Alice/hvCpG_project/code/2024_hvCpG/05_hvCpGalgorithm/resultsDir/10X_CD4+CD8+/Atlas_batch%03d", task_id)
