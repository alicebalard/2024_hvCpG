...
load("/home/alice/2024_hvCpG/05_hvCpGalgorithm/resultsDir/Mariads/results_Maria_pos2check_1p0_0_6p1.RData")

Brent = data.frame(CpG = cpg_names[as.numeric(row.names(results_Maria_pos2check_1p0_0_6p1))],
                   alpha_Brent = as.vector(results_Maria_pos2check_1p0_0_6p1))
...
```{r}
load("/home/alice/2024_hvCpG/05_hvCpGalgorithm/resultsDir/Mariads/withAlpha0.5atStart/results_Nelder_Mead_my_list_mat_Mariads_test3000CpGsvec_1p0_0_6p1.RData")
NM = data.frame(CpG = row.names(results_Nelder_Mead_my_list_mat_Mariads_test3000CpGsvec_1p0_0_6p1),
                alpha_NM_old = as.vector(results_Nelder_Mead_my_list_mat_Mariads_test3000CpGsvec_1p0_0_6p1)) 
...
AtlasMetaData <- readxl::read_excel("../04_prepAtlas/41586_2022_5580_MOESM4_ESM.xlsx", sheet = 1, skip = 2)

table(AtlasMetaData$`Cell type`)
```
