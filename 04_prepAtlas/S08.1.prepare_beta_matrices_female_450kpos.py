...
---------------------------------
This script:
 1️⃣ Filters cell/tissue groups with at least 3 samples. NEW: only females
...
output_folder = "/SAN/ghlab/epigen/Alice/hvCpG_project/data/WGBS_human/AtlasLoyfer/10X_females"
...
meta = meta_all.loc[meta_all["sex"] == "F", :].copy()
...
#✅ Found 16 composite groups (Source Tissue + Cell type) with ≥ 3 samples.
...
#🔄 Processing Colon - Epithelium (3 samples)
#✅ Colon - Epithelium: median_sd = 0.0335, lambda = 4.1748
...
#✅ Saved all samples to: /SAN/ghlab/epigen/Alice/hvCpG_project/data/WGBS_human/AtlasLoyfer/10X_females/all_matrix_noscale.h5
...
#⏳ Processing group: Colon - Epithelium with 3 samples
...
#✅ Selected 222,257 CpGs (≥3 samples in ≥10 datasets, and present in allowed list).
